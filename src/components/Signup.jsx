          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="px-8 py-6">
              ...
              <form onSubmit={handleSubmit}>
                ...
                {/* Sign Up Link - Replaced with button */}
                <div className="mt-6">
                  <Link to="/signup">
                    <button className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white py-2 rounded-lg font-semibold hover:from-green-600 hover:to-emerald-700 transition-all transform hover:scale-[1.02] flex items-center justify-center gap-2">
